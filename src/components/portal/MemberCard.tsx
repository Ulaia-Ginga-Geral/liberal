         ...
         <div className="relative h-full flex flex-col p-4 text-white z-10">
            ...
            <div className="flex justify-between items-start mb-1">
               ...
               <div className="text-right">
                  ...
                  <p className="text-[7px] font-black text-yellow-400 uppercase tracking-widest">Secretariado Provincial do Cuanza Sul</p>
               </div>
            </div>
            ...
            <div className="mt-1 flex justify-between items-center text-[6px] font-black px-1">
               ...
               <p className="text-white uppercase tracking-widest">PL - Somos a nossa própria esperança</p>
            </div>
         </div>
      </div>
   );
